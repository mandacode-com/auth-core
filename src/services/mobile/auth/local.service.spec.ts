...
import { MobileAuthLocalService } from './local.service';
...
describe('local.service.spec.ts', () => {
  let service: MobileAuthLocalService;
  ...
  beforeEach(async () => {
    ...
    service = testingModule.get<MobileAuthLocalService>(MobileAuthLocalService);
  });
